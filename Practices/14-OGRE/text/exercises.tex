...
\begin{enumerate}
	...
	\item On left mouse click the character swings swords vertically, but there is also horizontal swing animation available, make him do that on on right mouse click
