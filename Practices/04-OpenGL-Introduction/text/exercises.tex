...
Hint: You do not have to make the character very detailed. Something like a \texttt{glutSolidCylinder} combined with a \texttt{glutSolidSphere} will do. If you want, though, you can try finding a suitable 3D model in the Wavefront .obj format and using it as shown in \verb#4_Object#.
